...
func SubmitJob(client *gqlclient.Client, ctx context.Context, manifest string) (submit *Job, err error) {
	op := gqlclient.NewOperation("mutation submitJob ($manifest: String!) {\n\tsubmit(manifest: $manifest, secrets: false) {\n\t\tid\n\t\towner {\n\t\t\tcanonicalName\n\t\t}\n\t}\n}\n")
